...
public class GestionCompanyDaoImpl implements GestionCompanyDao {
    ...
    private static final String SELECT_ALL_COMPANIES = "SELECT id, name FROM company ORDER BY name";
    private static final String SELECT_ONE_COMPANY = "SELECT id, name FROM company WHERE id=?";
